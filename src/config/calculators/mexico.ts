...
export const calculateMexicoAguinaldo = (inputs: Record<string, any>): CalculationResult => {
  ...
  // UMA 2026 Value ~ 113.14 MXN -> 30 UMA exempt
  const umaDaily2026 = 113.14;
  const exemptLimit = 30 * umaDaily2026; // 3,394.20 MXN exempt
  ...
  return {
    heroOutput: {
      ...
      isHero: true,
      type: 'positive',
      description: 'Monto libre que recibirás antes del 20 de diciembre tras aplicar la exención de 30 UMA y retención de ISR.',
    },
    breakdown: [
      {
        id: 'gross_aguinaldo',
      ...
      {
        id: 'exempt_amount',
        label: 'Parte Exenta de ISR (30 UMA)',
        value: exemptAmount,
        formattedValue: `+ ${formatMXN(exemptAmount)}`,
        type: 'positive',
        description: 'Monto libre de impuestos garantizado por Ley (Art. 93 Fracc. XIV LISR).',
      },
      {
        id: 'taxable_base',
    ...
    notes: [
      ...
      'La exención de 30 UMA equivale a $3,394.20 MXN para el ejercicio 2026.',
...
export const MEXICO_CALCULATOR_CONFIG: CalculatorConfig = {
  ...
  description: 'Calcula gratis tu aguinaldo neto 2026 en México conforme a la Ley Federal del Trabajo y exención de 30 UMA del ISR.',
  ...
  pages: {
    'aguinaldo-calculator': {
      ...
      title: 'Calculadora Aguinaldo Neto 2026 México — ISR y Ley Federal del Trabajo',
      h1: 'Calculadora de Aguinaldo Neto 2026 en México',
      metaDescription: 'Calcula libre de errores tu aguinaldo neto 2026 en México. Incluye exención de 30 UMA, cálculo proporcional y retención de ISR actualizada.',
      keywords: ['calculadora aguinaldo neto 2026', 'como calcular el aguinaldo en mexico', 'aguinaldo exento isr 2026', 'ley federal del trabajo aguinaldo'],
...
#### 2. Exención de ISR (30 UMA)
Conforme al **Artículo 93, Fracción XIV de la Ley del Impuesto sobre la Renta (LISR)**, el aguinaldo está exento de ISR hasta por el equivalente a **30 Unidades de Medida y Actualización (UMA)** diarias:

* **UMA Diaria 2026**: ~$113.14 MXN
* **Monto Exento de Impuesto**: 30 × $113.14 = **$3,394.20 MXN**

Cualquier excedente sobre $3,394.20 MXN formará la **Base Gravable** a la que se le aplica la tarifa retención de ISR (Art. 96 o Art. 174 LISR).
      `,
      faqs: [
        {
        ...
        },
        {
          ...
          answer: 'Sí, pero solo por la parte que exceda 30 días de UMA ($3,394.20 MXN). Los primeros $3,394.20 MXN están completamente exentos de ISR.',
        },
      ],
      relatedPages: [
    ...
    'aguinaldo-neto-calculadora-2026': {
      ...
      title: 'Calculadora Aguinaldo Neto 2026 — Descuento ISR Exacto',
      h1: 'Calculadora Aguinaldo Neto 2026',
      metaDescription: 'Determina en segundos tu aguinaldo neto libre de impuestos para el ejercicio 2026 en México.',
...
Ingresa tu salario base y obtén el desglose detallado de lo que recibirás depositado en tu cuenta bancaria.
      `,
      faqs: [
        {
...
Aprende cómo opera la retención de ISR conforme a las tablas vigentes del SAT y el Reglamento del LISR.
      `,
      faqs: [
        {
          question: '¿Qué pasa si mi aguinaldo es menor a 30 UMA?',
          answer: 'Si tu aguinaldo bruto es menor o igual a $3,394.20 MXN, está 100% exento de ISR y no sufres ninguna retención.',
        },
      ],
      relatedPages: [
        { title: 'Calculadora Principal', href: '/mx/aguinaldo-calculator' },
